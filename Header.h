#ifndef _HEADERH_		//protectes from multiple including...
#define _HEADERH_		//... needs an #endif at bottom
...
//Mensagem de erro at x,y
void mensagem_de_erro (int x ,int y )
{
	gotoxy(x,y);printf("Digitou valores errados, tente novamente	");
	delay(1);
	gotoxy(x,y);printf("                                            ");
	gotoxy(x,y-1);printf(" ");
}
//show a number at a designated position
